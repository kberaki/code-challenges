...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let citiAJ =  /[A-J][a-j]\w*/ig
  let newArr = arr.join()
  citiAJ.test(newArr)
  let result2 = newArr.match(citiAJ)
...
const matchMonth = (input) => {
  // Solution code here...
  let hMonth = /^[Oo]ct(ober)?$/
  let newMonth= hMonth.test(input)
  //let newMonth = input.match(hMonth)
